...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        for (NSInteger i=0; i<5; i++)
        {
            ...
            UILabel*titleLb=[[UILabel alloc]initWithFrame:CGRectMake(F_I6_SIZE(20)+i*(WIDTH_VIEW+F_I6_SIZE(40)), F_I6_SIZE(50), F_I6_SIZE(50), F_I6_SIZE(20))];
        ...
        _btn1.frame=CGRectMake(F_I6_SIZE(20), F_I6_SIZE(0), F_I6_SIZE(40), F_I6_SIZE(60));
        _btn2.frame=CGRectMake(F_I6_SIZE(20)+(WIDTH_VIEW)+F_I6_SIZE(40), F_I6_SIZE(0), F_I6_SIZE(40), F_I6_SIZE(60));
        _btn3.frame=CGRectMake(F_I6_SIZE(20)+2*((WIDTH_VIEW)+F_I6_SIZE(40)), F_I6_SIZE(0), F_I6_SIZE(40), F_I6_SIZE(60));
        _btn4.frame=CGRectMake(F_I6_SIZE(20)+3*((WIDTH_VIEW)+F_I6_SIZE(40)), F_I6_SIZE(0), F_I6_SIZE(40), F_I6_SIZE(60));
        _btn5.frame=CGRectMake(F_I6_SIZE(20)+4*((WIDTH_VIEW)+F_I6_SIZE(40)), F_I6_SIZE(0), F_I6_SIZE(40), F_I6_SIZE(60));
