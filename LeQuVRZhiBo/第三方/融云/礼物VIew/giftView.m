...
- (UIButton*)payBtn
{
    if (!_payBtn) {
        ...
        _payBtn.frame=CGRectMake(DEVICE_WIDTH-F_I6_SIZE(135), F_I6_SIZE(225), F_I6_SIZE(60), F_I6_SIZE(30));
...
- (UIButton*)giveBtn
{
    if (!_giveBtn) {
        ...
        _giveBtn.frame=CGRectMake(DEVICE_WIDTH-F_I6_SIZE(70), F_I6_SIZE(225), F_I6_SIZE(60), F_I6_SIZE(30));
...
- (UILabel*)moneyLb
{
    if (!_moneyLb)
    {
        ...
        _moneyLb.frame=CGRectMake(F_I6_SIZE(10), F_I6_SIZE(225), DEVICE_WIDTH-F_I6_SIZE(100), F_I6_SIZE(20));
        _moneyLb.font=[UIFont systemFontOfSize:F_I6_SIZE(12)];
        _moneyLb.textColor=[UIColor whiteColor];
        [_bgView addSubview:_moneyLb];
    }
    return _moneyLb;
}
    ...
    [AFManager getReqURL:[NSString stringWithFormat:@"%@?id=%@",YUE,[USERDEFAULT valueForKey:@"uid"]] block:^(id infor)
     {
         ...
         {
             self.moneyLb.text=[NSString stringWithFormat:@"星票：%@",infor[@"balance_xp"]];
         }
     } errorblock:^(NSError *error)
     {
